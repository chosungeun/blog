 ...
 * Contorller 와 ControllerAdvice 등 외부 연동과 관련된 부분만 활성화 되니 지금 같이 JPA
 * 기능까지 한번에 테스트 할 때는 @SpringBootTest 와 TestRestTemplete을 사용하면 됩니다.
 *
 * */
...
public class PostsApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception {
        ...
        //then
        //ssertThat(responseEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
